	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="adminMain.jsp" class="nav-link">Admin</a></li>
	          <li class="nav-item"><a href="WebContent/html/about.html" class="nav-link">About</a></li>
	          <li class="nav-item"><a href="destination.html" class="nav-link">Destination</a></li>
	          <li class="nav-item"><a href="contact.html" class="nav-link">Contact</a></li>
	          <li class="nav-item cta"><a href="register.jsp" class="nav-link">LOGIN / SIGN UP</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
...
<!--             <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Travel with JK LINES guarantees the best memory</h1>
 --><!--             <p class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">There are people never used JK LINES service, but there are no one used JK LINES service once</p>
 -->          </div>
        </div>
      </div>
    </div>
...
<!-- 		          					<div class="icon"><span class="ion-ios-calendar"></span></div>
 -->				                <input type="text" class="form-control checkin_date" placeholder="Depart Date">
				              </div>
			              </div>
		        			</div>
		        			<div class="col-lg align-items-end">
		        				<div class="form-group">
		        					...
		        					<div class="form-field">
<!-- 		          					<div class="icon"><span class="ion-ios-calendar"></span></div>
 -->				                <input type="text" class="form-control checkout_date" placeholder="Return Date">
				              </div>
			              </div>
		        			</div>
		        		<form action=reservation method="post"> 
		        			<div class="col-lg align-self-end">
		        				<div class="form-group">
		        					<div class="form-field">
				                <input type="submit" value="Search" class="form-control btn btn-primary"><a href="Schedule.jsp"></a>
				              </div>
			              </div>
		        			</div>
		        			</form>
    		...
    		<div class="row">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				...
	    				<div class="text">
	    					<h4 class="price">Start from $20</h4>
	    					<span>15 Days Tour</span>
	    					<h3><a href="project.html">Chicago, Illinois</a></h3>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				...
	    				<div class="text">
	    					<h4 class="price">Start from $25</h4>
	    					<span>15 Days Tour</span>
	    					<h3><a href="project.html">Minneapolis, Minnesota</a></h3>
	    					<div class="star d-flex clearfix">
	    						<div class="mr-auto float-left">
		    						<span class="ion-ios-star"></span>
		    						<span class="ion-ios-star"></span>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				...
	    				<div class="text">
	    					<h4 class="price">Start from $20</h4>
	    					<span>15 Days Tour</span>
	    					<h3><a href="project.html">Milwaukee, Wisconsin</a></h3>
	    					<div class="star d-flex clearfix">
	    						<div class="mr-auto float-left">
		    						<span class="ion-ios-star"></span>
		    						<span class="ion-ios-star"></span>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				...
	    				<div class="text">
	    					<h4 class="price">Start from $$22</h4>
	    					<span>15 Days Tour</span>
	    					<h3><a href="project.html">Des Moines, Iowa</a></h3>
	    					<div class="star d-flex clearfix">
	    						<div class="mr-auto float-left">
		    						<span class="ion-ios-star"></span>
		    						<span class="ion-ios-star"></span>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">JK LINES</h2>
              <p>Best Bus Lines in Midwest.</p> 
              <p>Enjoy your trips to Chicago, Minneapolis, Milwaukee and Des Moines with our service</p>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">2015 Cherokee Drive, West Chicago, Illinois, USA</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+1 715 497 7762</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">0122wndnjs@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
